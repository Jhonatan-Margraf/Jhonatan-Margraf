...
<p align="center">
  QA Tester | Fundador da <strong>BearFlow</strong> | Estudante de IA e Ciência de Dados<br>
  Técnico em Informática para Internet pelo <strong>IFPR</strong><br>
  Graduando em Inteligência Artificial e Ciência de Dados na <strong>Faculdade Donaduzzi</strong> (Biopark Educação)<br>
  Coautor de artigo científico publicado e vencedor de dois hackathons de tecnologia<br>
  Interesse em testes de software, visão computacional e automação inteligente
</p>
<br>
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=py,js,ts,pytorch,postgres,mysql,docker,git,github,linux" alt="My Skills" />
  </a>
</div>
<br>
<div align="center">
